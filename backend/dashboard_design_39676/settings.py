"""
Django settings for dashboard_design_39676 project.
...
ROOT_URLCONF = 'dashboard_design_39676.urls'
...
WSGI_APPLICATION = 'dashboard_design_39676.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dashboard_design_39676 API",
    "DESCRIPTION": "API documentation for dashboard_design_39676 App",
    "VERSION": "v1",
}
